...
<body>
  ...
  <div class="container">
    <div class="vehicle-details">
      <img src="./imagens/car1.png" alt="Veículo">

      <div class="info">
        <h1 class="vehicle-name">Audi Supra TT</h1>
        <p class="vehicle-model">Modelo: Supra TT</p>
        <p class="vehicle-brand">Marca: Audi</p>
